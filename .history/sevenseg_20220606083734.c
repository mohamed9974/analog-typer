...
//==============================================================================
void UpdateSevenSeg(uint8_t number_of_custom_char,uint8_t custom_char_pos){
    for(custom_char_pos = 0; custom_char_pos < 10; custom_char_pos++){
        number_of_custom_char = custom_char_pos + 1;
        DisplaySevenSeg(number_of_custom_char, custom_char_pos);
    }
}